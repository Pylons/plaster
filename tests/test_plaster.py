...
class TestGetLoader(unittest.TestCase):
    ...
    def test_str_loader(self):
        config_uri = 'yaml+other://development.ini'
        loader = plaster.get_loader(config_uri)

        self.assertIsInstance(loader.uri, str)

    def test_uri_loader(self):
        config_uri = 'yaml://development.ini'
        loader = plaster.get_loader(config_uri)

        self.assertIsInstance(loader.uri, plaster.parse.ParseResult)
